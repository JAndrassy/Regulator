...
void printValuesJson(FormattedPrint& client) {
  client.printf(F("{\"st\":\"%c\",\"v\":\"%s\",\"r\":\"%d %d %d\",\"p\":%d,\"ec\":%d,\"ts\":%d,\"cp\":%d"),
      state, version, mainRelayOn, bypassRelayOn, valvesBackRelayOn, powerPilotPlan,
